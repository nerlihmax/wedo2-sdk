...
import type { Wedo2DistanceSensor } from '@/devices';
import type { Wedo2Led } from '@/devices';
import type { Wedo2Motor } from '@/devices';
import type { Wedo2TiltSensor } from '@/devices';
